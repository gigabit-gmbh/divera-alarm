...
apt install poppler-utils tesseract-ocr ocrmypdf tesseract-ocr-deu libnotify-bin notification-daemon cups notify-osd at-spi2-core libnotify-bin dbus unclutter
